...
const IS_BIG_PHONE = wp(50) > 390; //check change to this with new formatting

const ITEM_WIDTH = wp('45%');
const SMALL_FONT_SIZE = wp('2%');
const FONT_SIZE = wp('2.5%');
const BIG_FONT_SIZE = wp('3%');

const LetterForHistory = props => {
  ...
  return (
    <View style={{margin: 0, zIndex: props.senderAddress}}>
      <ImageBackground 
...
export default LetterForHistory;